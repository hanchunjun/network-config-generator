...
class HuaweiAccessSwitchConfig(BaseConfigPage):
    ...
    def init_panels(self):
        ...
        self.ssh_username_input.setFixedWidth(140)
        ...
        self.ssh_user_password_input.setFixedWidth(140)
        ...
        self.telnet_username_input.setFixedWidth(140)
        ...
        self.telnet_user_password_input.setFixedWidth(140)
