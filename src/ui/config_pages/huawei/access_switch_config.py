...
class HuaweiAccessSwitchConfig(BaseConfigPage):
    ...
    def init_panels(self):
        ...
        self.ssh_username_input.setStyleSheet("""
            QLineEdit {
                border: 1px solid #CCCCCC;
                padding: 4px 8px;
                font-size: 14px;
        ...
        self.ssh_user_password_input.setStyleSheet("""
            QLineEdit {
                border: 1px solid #CCCCCC;
                padding: 4px 8px;
                font-size: 14px;
        ...
        self.telnet_username_input.setStyleSheet("""
            QLineEdit {
                border: 1px solid #CCCCCC;
                padding: 4px 8px;
                font-size: 14px;
        ...
        self.telnet_user_password_input.setStyleSheet("""
            QLineEdit {
                border: 1px solid #CCCCCC;
                padding: 4px 8px;
                font-size: 14px;
