...
class RuijieACConfig(BaseConfigPage):
    ...
    def init_panels(self):
        ...
        tab8.content_layout.addStretch()
        ...
        tab9.content_layout.addStretch()
        ...
        tab10.content_layout.addStretch()
    ...
    def generate_config(self):
        ...
        if 'Console 串口登录配置' in checked_cards:
            ...
            if data.get('console_password'):
                ...
                config.append(f"password 7 {data.get('console_password')}")
                config.append("login")
                config.append("exit")
            elif data.get('console_username') and data.get('console_user_password'):
                config.append(f"username {data.get('console_username')} privilege 15 password 7 {data.get('console_user_password')}")
                config.append("line console 0")
