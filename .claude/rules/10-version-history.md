...
- ✅ **ThemeEngine 更新**：三套按钮 QSS 统一灰色边框风格，hover 变色
- ✅ **命令生成页面修复**：按钮样式与其他页面完全一致
- ✅ **复选框修复**：清除孤立 QSS 片段，保留原生勾选图标
- ✅ **ECC 技能安装**：29 个核心技能 + cisco-ios-patterns 已安装
- ✅ **RTK 升级**：v0.41.0 → v0.42.0
- ✅ **gstack 安装**：浏览器自动化测试工具已安装
